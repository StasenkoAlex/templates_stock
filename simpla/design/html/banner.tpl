...
<form method=post id=product>
	...
	<div id="column_left">
		...
		<div class="block layer">
			<h2>Описание</h2>
			<ul>
				<li><textarea name="description" class="simpla_inp"/>{$banner->description|escape}</textarea></li>
			</ul>
		</div>
	...
	<br />
		...
		<div class="block layer">
			...
			if($('.banner{$banner->id}').size()){ldelim}<br>
				{$otstup1}$('.banner{$banner->id}').bxSlider({ldelim}<br>
					{$otstup2}mode: 'horizontal',<br>
					{$otstup2}speed: 500,<br>
					{$otstup2}adaptiveHeight: true,<br>
					{$otstup2}pager: true,<br>
					{$otstup2}controls: true,<br>
					{$otstup2}auto: false,<br>
					{$otstup2}pause: 3000,<br>
					{$otstup2}autoHover: false<br>
				{$otstup1}{rdelim});<br>
			{rdelim}<br><br>
