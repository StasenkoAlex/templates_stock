<?php /* Smarty version Smarty-3.1.18, created on 2018-02-28 11:39:36
         compiled from "simpla\design\html\banners_images.tpl" */ ?>
<?php /*%%SmartyHeaderCode:300255a098b5bebe3e9-38743115%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '726a2928ab9a2f42f3b46b3e1209badd1eea86a0' => 
    array (
      0 => 'simpla\\design\\html\\banners_images.tpl',
      1 => 1519729658,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '300255a098b5bebe3e9-38743115',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_5a098b5c20bff9_94022913',
  'variables' => 
  array (
    'banner' => 0,
    'keyword' => 0,
...
<?php if ($_valid && !is_callable('content_5a098b5c20bff9_94022913')) {function content_5a098b5c20bff9_94022913($_smarty_tpl) {?>
...
<div class="banners_links">
	<a href="index.php?module=BannersImagesAdmin" class="active">Баннера</a>
...
<?php } else { ?>
	<?php $_smarty_tpl->tpl_vars['meta_title'] = new Smarty_variable('Баннера', null, 1);
if ($_smarty_tpl->parent != null) $_smarty_tpl->parent->tpl_vars['meta_title'] = clone $_smarty_tpl->tpl_vars['meta_title'];?>
<?php }?>
...
">
			<div class="move cell"><div class="move_zone"></div></div>
	 		<div class="checkbox cell">
				<input type="checkbox" name="check[]" value="<?php echo $_smarty_tpl->tpl_vars['banners_image']->value->id;?>
"/>				
			</div>
...
<div id="right_menu">
	...
	<!-- Фильтры -->
	<ul>
		<li <?php if (!$_smarty_tpl->tpl_vars['filter']->value) {?>class="selected"<?php }?>><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('brand_id'=>null,'banner_id'=>null,'keyword'=>null,'page'=>null,'filter'=>null),$_smarty_tpl);?>
">Все баннера</a></li>
		<li <?php if ($_smarty_tpl->tpl_vars['filter']->value=='visible') {?>class="selected"<?php }?>><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('keyword'=>null,'brand_id'=>null,'banner_id'=>null,'page'=>null,'filter'=>'visible'),$_smarty_tpl);?>
">Активные</a></li>
		<li <?php if ($_smarty_tpl->tpl_vars['filter']->value=='hidden') {?>class="selected"<?php }?>><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('keyword'=>null,'brand_id'=>null,'banner_id'=>null,'page'=>null,'filter'=>'hidden'),$_smarty_tpl);?>
">Неактивные</a></li>
	</ul>
	<!-- Фильтры -->
	...
	<?php if ($_smarty_tpl->tpl_vars['banners']->value) {?>
	<ul>
		<li <?php if (!$_smarty_tpl->tpl_vars['banner']->value->id) {?>class="selected"<?php }?>><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('banner_id'=>null,'brand_id'=>null),$_smarty_tpl);?>
">Все группы</a></li>	
		<?php  $_smarty_tpl->tpl_vars['b'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['b']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['banners']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['b']->key => $_smarty_tpl->tpl_vars['b']->value) {
...
" <?php if ($_smarty_tpl->tpl_vars['banner']->value->id==$_smarty_tpl->tpl_vars['b']->value->id) {?>class="selected"<?php } else { ?>class="droppable banner"<?php }?>><a href='<?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['b']->value->id;?>
