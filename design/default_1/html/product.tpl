...
<div class="product">
	...
	<!-- Большое фото -->
	{if $product->image}
		<a class="product-image" href="{$product->image->filename|resize:800:600:w}" class="zoom" rel="group"><img src="{$product->image->filename|resize:300:300}" alt="{$product->product->name|escape}" /></a>
